...
# Modifications : file updated to work with the demo application in this repository
...
class PubsubMessageHandler(object):
  ...
  def _PublishInferenceResultsReady(self, image_instance_path):
    ...
    try:
      self.publisher.publish(
          FLAGS.publisher_topic_path, data=image_instance_path.encode("utf-8"))
  ...
  def _PubsubCallback(self, message):
    ...
    if self._dicom_store_path:
      ...
      result = '{"basePath" : "' + image_instance_path + '","reportPath":"' + structured_report_path + '"}'
      self._PublishInferenceResultsReady(result)
